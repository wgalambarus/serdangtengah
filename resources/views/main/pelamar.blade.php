...
@section('content')
  <div class="flex flex-col lg:flex-row justify-between items-center mb-6 mt-4 gap-4">
    ...
    <div class="flex flex-wrap items-center gap-3 w-full lg:w-auto">
      ...
      <form method="GET" class="relative">
        <input type="text" name="search" value="{{ $search }}" placeholder="Cari nama pelamar" class="w-48 lg:w-60 px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg 
      ...
      <div class="relative">
        <button id="filterBtn" class="flex items-center gap-2 px-4 py-2 border border-gray-300 bg-white rounded-lg 
      ...
      {{-- TOMBOL TAMBAH --}}
      <button id="btnTambahPelamar" class="flex items-center gap-2 px-5 py-2.5 rounded-lg text-white font-medium shadow-sm 
            ...
            <tr>
              ...
              <th class="px-6 py-3">
                <button type="button" class="flex items-center gap-1 hover:text-gray-900"
                  ...
                  <span class="flex flex-col -mt-1">
                    <svg xmlns="http://www.w3.org/2000/svg"
                      class="w-3 h-3 {{ ($sortBy === 'nomor_hp' && $sortDir === 'asc') ? 'text-blue-600' : 'text-gray-400' }}"
                      fill="currentColor" viewBox="0 0 20 20">
                      <path d="M10 3l5 7H5l5-7z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg"
                      class="w-3 h-3 {{ ($sortBy === 'nomor_hp' && $sortDir === 'desc') ? 'text-blue-600' : 'text-gray-400' }}"
                      fill="currentColor" viewBox="0 0 20 20">
                      <path d="M10 17l-5-7h10l-5 7z" />
                    </svg>
                  </span>
  ...
  <div id="overlay"
    ...
    <div id="modalForm"
      class="hidden bg-white rounded-xl shadow-lg w-full max-w-3xl p-8 relative overflow-y-auto max-h-[90vh]">
      ...
      <form id="pelamarForm" onsubmit="handleSubmit(event)" class="space-y-6" enctype="multipart/form-data" novalidate>
        ...
        <div id="step1" class="space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" name="nama_lengkap" id="nama_lengkap" required minlength="3" maxlength="255"
                pattern="[A-Za-z\s.]+"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
              <p class="text-xs text-red-500 mt-1 hidden" id="error_nama_lengkap">Nama lengkap harus diisi (min. 3
                karakter, hanya huruf)</p>
            </div>

            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Tempat Lahir</label>
              <input type="text" name="tempat_lahir" id="tempat_lahir" maxlength="255" pattern="[A-Za-z\s]+"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
              <p class="text-xs text-red-500 mt-1 hidden" id="error_tempat_lahir">Tempat lahir hanya boleh berisi huruf
              </p>
            </div>

            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Lahir</label>
              <input type="date" name="tanggal_lahir" id="tanggal_lahir" max="{{ date('Y-m-d') }}" min="1950-01-01"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
          ...
          <p class="text-xs text-red-500 mt-1 hidden" id="error_pendidikan_terakhir">Isi pendidikan terakhir terlebih
            dahulu</p>
          <div>
          ...
          <div>
            ...
            <input type="tel" name="nomor_hp" id="nomor_hp" pattern="[0-9]{10,15}" maxlength="15"
        ...
        <div id="step2" class="space-y-6 hidden">
          <div>
            ...
            <input type="file" name="cv" id="cv" accept=".pdf" onchange="validateFile('cv')"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
          ...
          <div>
            ...
            <input type="file" name="pas_foto" id="pas_foto" accept=".pdf" onchange="validateFile('pas_foto')"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
          ...
          <div>
            ...
            <input type="file" name="ktp" id="ktp" accept=".pdf" onchange="validateFile('ktp')"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
          ...
          <div>
            ...
            <input type="file" name="ijazah" id="ijazah" accept=".pdf" onchange="validateFile('ijazah')"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
          ...
          <div>
            ...
            <input type="file" name="transkrip_nilai" id="transkrip_nilai" accept=".pdf"
              onchange="validateFile('transkrip_nilai')"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
            <p id="transkrip_nilai_current" class="text-xs text-gray-500 mt-1"></p>
            <p class="text-xs text-red-500 mt-1 hidden" id="error_transkrip_nilai">File harus berformat PDF dan maksimal
              2MB</p>
          </div>

          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Kartu BPJS (.pdf)</label>
            <input type="file" name="kartu_bpjs" id="kartu_bpjs" accept=".pdf" onchange="validateFile('kartu_bpjs')"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
            <p id="kartu_bpjs_current" class="text-xs text-gray-500 mt-1"></p>
            <p class="text-xs text-red-500 mt-1 hidden" id="error_kartu_bpjs">File harus berformat PDF dan maksimal 2MB
            </p>
          </div>

          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Surat Keterangan Pengalaman Kerja (.pdf)</label>
            <input type="file" name="suket_pengalaman_kerja" id="suket_pengalaman_kerja" accept=".pdf"
              onchange="validateFile('suket_pengalaman_kerja')"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
            <p id="suket_pengalaman_kerja_current" class="text-xs text-gray-500 mt-1"></p>
            <p class="text-xs text-red-500 mt-1 hidden" id="error_suket_pengalaman_kerja">File harus berformat PDF dan
              maksimal 2MB</p>
          </div>
          ...
          <div>
            ...
            <p class="text-xs text-red-500 mt-1 hidden" id="error_daftar_riwayat_hidup">File harus berformat PDF dan
              maksimal 2MB</p>
            </label>
          </div>
